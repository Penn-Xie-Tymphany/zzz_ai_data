"""工具注册表：ToolSpec / ToolExecutionResult / ToolRegistry / 默认注册。

# 来源：官方 KDD Cup 2026 DataAgent-Bench starter kit（PHASE_1/data_agent_baseline）
# 路径：tools/registry.py ｜ 用途：自研 penn_data_agent 可复用工具层
...
from .sqlite import execute_read_only_sql, inspect_sqlite_schema
